...
//            location = SkystoneLocation.NONE;
        ...
        Scalar lowHSV = new Scalar(100,125,0); // lower bound HSV for yellow
        Scalar highHSV = new Scalar(145,355, 355);  // higher bound HSV for yellow
        Mat thresh = new Mat();
...
//            telemetry.update();
            ...
            if (boundRect[i].width >20 && boundRect[i].height > 120&&boundRect[i].width < 1000&&boundRect[i].height <1000)
            {
                ...
                if (full_location != 1) {
                    ...
                    telemetry.addData("Height:", boundRect[i].height);
                    telemetry.addData("Y:", this.x+(width/2));
...
//
//    }
    public double getArea(){return this.height;}
