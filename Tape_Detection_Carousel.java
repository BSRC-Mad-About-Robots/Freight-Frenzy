...
@Autonomous
public class Tape_Detection_Carousel extends LinearOpMode {
    // Handle hardware stuff...

    int width = 960;
    int height = 720;//changed this
    // store as variable here so we can access the location
    Test_OpenCV_BlueTape detector = new Test_OpenCV_BlueTape(telemetry, 105);
    ...
    //                         Parl.setPower(0.0);
        ...
        inchestogo=Math.abs((546.0/5-currentarea)/62.5);
        telemetry.addData("AreabyInch",inchestogo);
        telemetry.addData("AreabyInch",currentarea);
        double adjacent=Math.abs((654.0/2.5-final_valY))/60;
