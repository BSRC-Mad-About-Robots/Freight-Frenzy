...
@Autonomous(name="Auto: Blue Vision")
...
double TargetPositionY=0;
    ...
    public void AlignmentToSH(){
        ...
        inchestogo=((394-currentarea)/13.69);
    ...
    //   sleep(1000);
      ...
      MoveBackACDC(22,0.8,-0.2,5);
      Parl.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                Parl.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                Parl.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                Parl.setDirection(DcMotorSimple.Direction.REVERSE);
                Parl.setTargetPosition((int)2430);
                Parl.setPower(1.0);
                sleep(30);
      Bask.setPower(0.0);
...
sleep(20);
      ...
      FL.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        BL.setDirection(DcMotorSimple.Direction.FORWARD);
        BR.setDirection(DcMotorSimple.Direction.FORWARD);
        setTargetPosition(-(int)(34.55*79));
        FL.setPower(1.0);
        FR.setPower(1.0);
        BL.setPower(0.258);
        BR.setPower(0.258);
      ...
      sleep(20);
            ...
            sleep(50);
            Bask.setPower(-1.0);
            MoveForwardACDC(23,0.88,0.12,5);
            sleep(20);
            nudgeToAngle(87.8);
