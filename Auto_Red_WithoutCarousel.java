...
@Autonomous(name="Auto_Red_WithoutCarosel")
public class Auto_Red_WithoutCarousel extends LinearOpMode 
{
    ...
    while ((Parl.isBusy())){}
    Parl.setPower(0.0); 
      MoveLeft(32.8-diagnal,1.0/1.5,power/1.5);
      ...
      BL.setDirection(DcMotorSimple.Direction.FORWARD);
      BR.setDirection(DcMotorSimple.Direction.FORWARD);
      setTargetPosition((int)(32.8-diagnal)*79);
        FL.setPower(1.0);
        FR.setPower(1.0);
        BL.setPower(0.3);
        BR.setPower(0.3);
    ...
    Parl.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    Parl.setDirection(DcMotorSimple.Direction.REVERSE);
    Parl.setTargetPosition((int)3280);
    Parl.setPower(0.8);
    while ((Parl.isBusy())){}
    Parl.setPower(0.0);
      FL.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
