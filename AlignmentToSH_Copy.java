...
@Autonomous(name="AlignmetToBarier")
public class AlignmentToSH_Copy extends LinearOpMode {
    // Handle hardware stuff...

    int width = 960;
    int height = 720;//changed this
    // store as variable here so we can access the location
    TestOpencv_Copy detector = new TestOpencv_Copy(telemetry);
