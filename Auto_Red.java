...
public class Auto_Red extends LinearOpMode 
{
    ...
    public void  MoveLeft(double inches,double pow, double difference,int parl_var)
    {
      ...
      {
      FL.setPower((pow-difference)/3);
      FR.setPower(pow/3);
      BL.setPower(pow/3);
      BR.setPower((pow-difference)/3); }
          if(parl_var>0)
          {
    ...
    // //   MoveBack(1.5,0.09);
      ...
      FL.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        nudgeToAngle(0.0); 
        sleep(50);
        MoveForward(forward+0.3,1.0,0.0);
        sleep(50);
        Bask.setPower(1.0);
           while (colorSensor instanceof DistanceSensor && ((DistanceSensor) colorSensor).getDistance(DistanceUnit.CM)<3.9) 
                {}
