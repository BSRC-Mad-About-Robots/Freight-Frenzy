...
@TeleOp(name="FreightFrenzy_TeleOp",group="TeleOp")
public class Teleop_Code extends OpMode
{
    ...
    public void init()
    {
        ...
        Out = hardwareMap.crservo.get("Pk");
    ...
    public void loop()
    {
        ...
        if (gamepad2.right_stick_button&&in==false)
        {   in=true;
            In.setDirection(DcMotorSimple.Direction.REVERSE);
            Out.setDirection(CRServo.Direction.REVERSE);
            Out.setPower(1.0);
            sleep(300);
            Out.setPower(0.0);
            In.setPower(1.0);
        ...
        else if(in==true)   
        {
            ...
            In.setPower(1.0);
            Out.setDirection(CRServo.Direction.FORWARD);
            Out.setPower(1.0);
        ...
        //compliant wheel movemen        //delivery mechanism
        //to grab
