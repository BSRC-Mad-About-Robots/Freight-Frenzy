...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    final double COUNTS_PER_INCH = 1304.458598726115;

    //Hardware map names for the encoder wheels. Again, these will change for each robot and need to be updated below
    String verticalLeftEncoderName = "FR", verticalRightEncoderName = "BL", horizontalEncoderName = "FL";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while(opModeIsActive()){
            telemetry.addData("VL", verticalLeft.getCurrentPosition());
            telemetry.addData("VR", verticalRight.getCurrentPosition());
            telemetry.addData("H", horizontal.getCurrentPosition());
